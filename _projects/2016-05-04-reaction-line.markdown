...
I programmed the majority of the app in Swift using the open-source game engine [cocos2d-objc][cocos2d-github].
...
I went for a minimalistic design while basing my color pallete off of those that went well with the primary beige background. I'm also opposed to placing separate, darker object underneath text just for contrast, so I added drop shadow where necessary to make the HUD more readable.
